  ...
  return (
    <div className="border flex items-center justify-between gap-1 text-sm p-4 rounded-md bg-white">
      <div className="flex flex-col gap-2">
        <p className="text-[0.6rem] sm:text-xs font-medium uppercase">Total <span className="capitalize">{type}</span></p>
        <span className="text-base sm:text-lg font-medium">{count || 0}</span>
      </div>
      <div className="p-1 sm:p-3 bg-slate-100 rounded-full">
